		...
		<tr>
			...
			<table border="0" cellpadding="0" style="border-collapse: collapse" width="1002" id="table8">
				<tr>
					...
					<td valign="top" bgcolor="#79B500" style="width: 30">
...
<form action="schedule1.php" class="font1" method="post" style="width:230px; height: 418px" name="Flightrequest" >
		<fieldset name="Group1" style="border-width: 0px; width: 229px; height: 18px" class="newStyle1">
		<div class="auto-style2">
		<input name="Radio1" style="width: 28px" tabindex="1" type="radio" value="One-way" checked="checked" />ONE-WAY&nbsp;&nbsp;&nbsp;
		<input name="Radio1" style="width: 28px" tabindex="1" type="radio" value="Two-way" />ROUND-TRIP<br />
		</div>
		<div class="auto-style3" style="width: 151px">
			<br>&nbsp;Origin<br /><select class="newStyle1" name="SelectFrom" style="width: 142px; height: 26px;"required>
			<option></option>
...
{ dateFormat: 'yy/mm/dd'});
	...
	</script>Destination<br class="Formlayout" /><select name="SelectTo" style="width: 142px; height: 26px;" class="newStyle1"required>
			<option></option>
			<option>Martinique</option>
			<option>Saint Lucia</option>
...
<!-- End: Constant Contact HTML for OptIn Tag --></td>
					...
					<td valign="top"  bgcolor="#FFFFFF" style="width: 702"  >
						<?php
//				include('step2.php');
				?>
					</td>
		...
		<tr>
			...
			<div align="center">
				<table border="0" cellpadding="0" style="border-collapse: collapse; font-family:Arial; font-size:8pt; color:#FFFFFF" width="950" id="table4" height="100%">
					<tr>
						<td bgcolor="#006634">
						<img border="0" src="images/bottom1.jpg" width="1000" height="18"></td>
					</tr>
					<tr>
						<td bgcolor="#006634">
